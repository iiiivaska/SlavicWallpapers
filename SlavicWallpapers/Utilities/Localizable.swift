...
enum Localizable {
    ...
    enum Menu {
        ...
        static let backgroundUpdate = NSLocalizedString("menu.background_update", comment: "Background update toggle")
    ...
    enum Error {
        ...
        static let invalidImageData = NSLocalizedString("error.invalid_image", comment: "Invalid image data")
        static let cacheSaveFailed = NSLocalizedString("error.cache_save_failed", comment: "Failed to save image")
        static let wallpaperSetFailed = NSLocalizedString("error.wallpaper_set_failed", comment: "Failed to set wallpaper")
        static let maxRetryAttemptsReached = NSLocalizedString("error.max_retry_reached", comment: "Max retry attempts reached")
    ...
    enum Time {
        ...
        static let hoursAndMinutes = NSLocalizedString("time.hours_and_minutes", comment: "Hours and minutes format")
        static let updateInterval = NSLocalizedString("time.update_interval", comment: "Update interval title")
